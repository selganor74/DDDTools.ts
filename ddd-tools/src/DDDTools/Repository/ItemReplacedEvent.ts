...
namespace DDDTools.Repository {
    ...
    export class ItemReplacedEvent<TAggregate> extends BaseRepositoryEvent<ItemReplacedEvent<TAggregate>, TAggregate> implements IDomainEvent {
        __typeName = Events.ItemReplacedEvent;
        __typeVersion = "v1";
    }
