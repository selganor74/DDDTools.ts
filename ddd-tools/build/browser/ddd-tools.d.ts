...
declare namespace DDDTools.StateMachine {
    class StateMachineDefinitionRegistry {
        ...
        static getStateMachine<TStatuses, TEvents>(stateMachineType: string, stateMachineVersion: string): StateMachineDefinition<any, any>;
    }
}
/**
 * Collection of general and commonly used ValueObjects.
...
declare namespace DDDTools.UnitOfWork {
     ...
     * Simple UnitOfWork for a single Repository.
     */
    interface IUnitOfWorkAsync<T extends IAggregateRoot<T, TKey>, TKey extends IKeyValueObject<TKey>> {
        /**
         * Retrieves an item from the Repository or from the UnitOfWork, given its Id.
         */
...
declare namespace DDDTools.UnitOfWork {
     ...
     * Simple UnitOfWork for a single Repository.
     */
    class UnitOfWorkAsync<T extends BaseAggregateRoot<T, TKey>, TKey extends IKeyValueObject<TKey>> implements IUnitOfWorkAsync<T, TKey> {
        private idMap;
        private repository;
        private dispatcher;
