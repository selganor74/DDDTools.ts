...
declare namespace DDDTools {
    interface IAggregateRoot {
        ...
        unregisterEventHandlers(): any;
    }
}
declare namespace DDDTools {
    interface IDomainEvent extends StatefulObject.IStateful {
    }
}
...
declare namespace DDDTools.DomainEvents {
    ...
    class Dispatcher {
        private static delegatesRegistry;
        static clear(): void;
        ...
        private static buildErrorMessage(Errors);
    }
}
declare namespace DDDTools {
...
declare namespace DDDTools {
    ...
    abstract class BaseAggregateRoot<T extends IEntity<T, TKey>, TKey extends IKeyValueObject<TKey>> extends BaseEntity<T, TKey> implements IAggregateRoot {
        raiseEvent(event: IDomainEvent): void;
        registerEventHandler(eventTypeName: string, eventHandler: IEventHandler): void;
        unregisterEventHandler(eventTypeName: string, eventHandler: IEventHandler): void;
        abstract registerEventHandlers(): any;
        abstract unregisterEventHandlers(): any;
    }
}
declare namespace DDDTools {
...
declare namespace CdC.Model {
    ...
    class Offerta extends DDD.BaseAggregateRoot<Offerta, VOs.IdOfferta> {
        __typeName: string;
        private descrizioneOfferta;
        private offertePerVarianti;
...
declare namespace CdC.Model.ValueObjects {
    import DDD = DDDTools;
    import Guid = DDDTools.ValueObjects.Guid;
    class IdOfferta extends DDD.BaseKeyValueObject<IdOfferta> {
        private idOfferta;
        __typeName: string;
